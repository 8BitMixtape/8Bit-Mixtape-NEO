...
void loop(void) {
  ...
  */
  ...
  if (tempColor < 1) tempColor = 1;
  if (tempColor > 160) tempColor = 160;
  pixels.setPixelColor(0, Wheel(tempColor));
  //pixels.setPixelColor(0, Wheel(160));
  
  //showPixel = map(recalc, lowTemp, maxTemp, 7, 0);
  //if (showPixel < 0) showPixel = 0;
