...
{color("Goldenrod") 
    ...
    translate ([woodThickness,screwDiam/2-nutDiam/2,0]) cube([nutThickness,nutDiam,woodThickness],false);
}
...
{color("DarkSlateGray") 
    ...
    #translate([woodThickness*1.5+1,boxHeight/2,-1]) cylinder(  woodThickness+2,    d=screwDiam, true);
    #translate([boxLength-woodThickness*1.5-1,boxHeight/2,-1]) cylinder(  woodThickness+2,    d=screwDiam, true);
    #translate([pcbHeight+woodThickness*0.5-1,boxHeight/2,-1]) cylinder(  woodThickness+2,    d=screwDiam, true);
    }
}
